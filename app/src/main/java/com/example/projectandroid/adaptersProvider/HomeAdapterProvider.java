...
public class HomeAdapterProvider extends RecyclerView.Adapter<HomeAdapterProvider.ViewHolder>{
    private Context context;
    private List<Item> itemList;
    private ItemListener itemListener;
    public RelativeLayout relativeLayout;

    public HomeAdapterProvider(Context context, List<Item> itemList, ItemListener itemListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_room_detail_provider, parent, false);
