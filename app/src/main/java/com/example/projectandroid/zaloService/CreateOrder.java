package com.example.projectandroid.zaloService;

import com.example.projectandroid.zaloService.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            AppId = String.valueOf(AppInfor.APP_ID);
            ...
            Mac = Helpers.getMac(AppInfor.MAC_KEY, inputHMac);
        }
    }
    ...
    public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = HttpProvider.sendPost(AppInfor.URL_CREATE_ORDER, formBody);
        return data;
    }
}
